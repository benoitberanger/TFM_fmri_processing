...
e.getSerie('run_INDIVIEW_01_nm').addStim('onsets','001_spm.mat','INDIVIEW_1',1)
e.getSerie('run_INDIVIEW_02_nm').addStim('onsets','002_spm.mat','INDIVIEW_2',1)
e.getSerie('run_INDIVIEW_03_nm').addStim('onsets','003_spm.mat','INDIVIEW_3',1)
e.getSerie('run_INDIVIEW_04_nm').addStim('onsets','004_spm.mat','INDIVIEW_4',1)
e.getSerie('run_INDIVIEW_05_nm').addStim('onsets','005_spm.mat','INDIVIEW_5',1)
onsetFile = e.getSerie('run_INDIVIEW_\d{2}_nm').getStim('INDIVIEW').toJob;
