...
e.getSerie('run_INDIVIEW_01_nm').addStim('onsets','001_spm_cossin.mat','INDIVIEW_1_cossin',1)
e.getSerie('run_INDIVIEW_02_nm').addStim('onsets','002_spm_cossin.mat','INDIVIEW_2_cossin',1)
e.getSerie('run_INDIVIEW_03_nm').addStim('onsets','003_spm_cossin.mat','INDIVIEW_3_cossin',1)
e.getSerie('run_INDIVIEW_04_nm').addStim('onsets','004_spm_cossin.mat','INDIVIEW_4_cossin',1)
e.getSerie('run_INDIVIEW_05_nm').addStim('onsets','005_spm_cossin.mat','INDIVIEW_5_cossin',1)
